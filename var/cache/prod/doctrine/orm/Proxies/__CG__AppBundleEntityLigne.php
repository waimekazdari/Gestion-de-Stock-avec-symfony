 ...
 */
class Ligne extends \AppBundle\Entity\Ligne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Ligne' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Ligne' . "\0" . 'quantite', '' . "\0" . 'AppBundle\\Entity\\Ligne' . "\0" . 'prix', '' . "\0" . 'AppBundle\\Entity\\Ligne' . "\0" . 'duree', '' . "\0" . 'AppBundle\\Entity\\Ligne' . "\0" . 'dateGarantie', '' . "\0" . 'AppBundle\\Entity\\Ligne' . "\0" . 'livraison', '' . "\0" . 'AppBundle\\Entity\\Ligne' . "\0" . 'article'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ligne $proxy) {
    ...
    public function setDateGarantie($dateGarantie)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateGarantie', [$dateGarantie]);
    ...
    public function getDateGarantie()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateGarantie', []);
