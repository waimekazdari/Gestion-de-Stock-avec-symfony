...
class UserRepositoryy extends EntityRepository
{
    ...
    public function search($searchParam) {
       ...
       $qb = $this->createQueryBuilder('u')
                ...
                ->addSelect('img');
        if(!empty($keyword))
            $qb->andWhere('concat(u.employe.nom) like :keyword or u.email like :keyword u.username like :keyword or u.roles like :keyword')
