...
class Service extends \AppBundle\Entity\Service implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Service' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Service' . "\0" . 'libele', '' . "\0" . 'AppBundle\\Entity\\Service' . "\0" . 'employes', '' . "\0" . 'AppBundle\\Entity\\Service' . "\0" . 'departement'];
        }
