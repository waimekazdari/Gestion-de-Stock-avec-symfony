 ...
 */
class Departement extends \AppBundle\Entity\Departement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Departement' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Departement' . "\0" . 'libele', '' . "\0" . 'AppBundle\\Entity\\Departement' . "\0" . 'services'];
        }
