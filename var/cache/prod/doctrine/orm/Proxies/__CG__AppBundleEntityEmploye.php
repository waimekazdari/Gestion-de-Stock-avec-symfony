...
class Employe extends \AppBundle\Entity\Employe implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'CIN', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'adresse', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'tel', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'sorties', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'expression_besoins', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'service', '' . "\0" . 'AppBundle\\Entity\\Employe' . "\0" . 'user'];
        }
