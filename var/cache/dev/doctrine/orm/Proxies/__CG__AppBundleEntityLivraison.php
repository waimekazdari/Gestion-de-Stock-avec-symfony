...
class Livraison extends \AppBundle\Entity\Livraison implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Livraison' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Livraison' . "\0" . 'refMarche', '' . "\0" . 'AppBundle\\Entity\\Livraison' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\Livraison' . "\0" . 'lignes', '' . "\0" . 'AppBundle\\Entity\\Livraison' . "\0" . 'fournisseur'];
        }
